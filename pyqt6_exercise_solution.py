...
class Window(QMainWindow):
    ...
    def closeEvent(self, a0: QtGui.QCloseEvent) -> None:
        ...
        # dlg.setText("Do you really want to close this app?")
...
class resetWindow(QDialog):
    def __init__(self):
        ...
        # self.buttonYes.clicked.connect(self.handleClickYes)

        self.buttonNo = QPushButton("No", self)
        # self.buttonNo.clicked.connect(self.handleClickNo)
